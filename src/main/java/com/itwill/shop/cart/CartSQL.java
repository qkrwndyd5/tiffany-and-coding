...
public class CartSQL {
	...
	public static final String CART_COUNT_BY_USERID_PRODUCT_NO_AND_OPTION = "select count(*) as p_count from cart c join userinfo u on c.userid=u.userid join product p on c.p_no = p.p_no where u.userid=? and c.p_no=? and p.p_option=?";
