...
<script type="text/javascript">
	...
	*/
	function openIdCheck(){
		...
		let idCheckWindow = window.open("user_id_check_form.jsp","checkForm","width=430,height=300,top="+top+",left="+left+",resizable = no,location=no, directories=no, status=no, menubar=no, scrollbars=no,copyhistory=no");
	}
